...
var creatorList = ['@CheaterGanteng','@alpha'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6285715028689 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'CheaterGanteng') return res.json(loghandler.invalidKey)
...
router.get('/short/ssur', async (req, res, next) => {
    var apikeyInput = req.query.apikey,
        url = req.query.url
